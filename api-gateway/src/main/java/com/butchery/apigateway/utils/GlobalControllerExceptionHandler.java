...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleDuplicatePhoneNumberException(WebRequest request, Exception ex) {
    ...
    public HttpErrorInfo handleInvalidEmailAddressException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
    ...
    @ResponseStatus(UNPROCESSABLE_ENTITY)
    @ExceptionHandler(ThisFieldIsRequiredException.class)
    public HttpErrorInfo handleThisFieldIsRequiredException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
